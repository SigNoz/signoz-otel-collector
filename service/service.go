...
func New(wrappedCollector collector.WrappedCollector, logger *zap.Logger, managerConfigPath string, collectorConfigPath string) (*service, error) {
...
// Start starts the Opamp connection and embedded collector
...
// Shutdown stops the Opamp connection and embedded collector
