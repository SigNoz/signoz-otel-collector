...
-- Materialized view
DROP VIEW IF EXISTS atrribute_keys_string_final_mv;
DROP VIEW IF EXISTS atrribute_keys_int64_final_mv;
DROP VIEW IF EXISTS atrribute_keys_float64_final_mv;
