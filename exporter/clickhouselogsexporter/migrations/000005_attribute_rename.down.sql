...
-- Materialized view
DROP table if exists attribute_keys_string_final_mv;
DROP table if exists attribute_keys_int64_final_mv;
DROP table if exists attribute_keys_float64_final_mv;
