...
type Writer interface {
	...
	WriteBatchOfSpansV2(ctx context.Context, span []*SpanV2, metrics map[string]usage.Metric) error
	WriteResourcesV2(ctx context.Context, resource map[int64]map[string]string) error
}
