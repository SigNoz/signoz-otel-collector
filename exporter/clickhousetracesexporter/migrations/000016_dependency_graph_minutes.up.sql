CREATE TABLE IF NOT EXISTS signoz_traces.dependency_graph_minutes (
...
CREATE MATERIALIZED VIEW IF NOT EXISTS signoz_traces.dependency_graph_minutes_service_calls_mv
...
CREATE MATERIALIZED VIEW IF NOT EXISTS signoz_traces.dependency_graph_minutes_db_calls_mv
TO signoz_traces.dependency_graph_minutes AS
SELECT
    serviceName as src,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS signoz_traces.dependency_graph_minutes_messaging_calls_mv
TO signoz_traces.dependency_graph_minutes AS
SELECT
    serviceName as src,
