CREATE TABLE IF NOT EXISTS signoz_traces.dependency_graph_minutes ON CLUSTER signoz (
...
CREATE MATERIALIZED VIEW IF NOT EXISTS signoz_traces.dependency_graph_minutes_messaging_calls_mv ON CLUSTER signoz
TO signoz_traces.dependency_graph_minutes AS
SELECT
    serviceName as src,
