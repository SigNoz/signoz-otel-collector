...
import (
	...
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/decode"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/attrs"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/emit"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/internal/fingerprint"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/internal/header"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/internal/reader"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/internal/scanner"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/internal/tracker"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/matcher"
	...
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/split"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/trim"
)
...
var allowFileDeletion = featuregate.GlobalRegistry().MustRegister(
	"logspipeline.filelog.allowFileDeletion",
...
var AllowHeaderMetadataParsing = featuregate.GlobalRegistry().MustRegister(
	"logspipeline.filelog.allowHeaderMetadataParsing",
