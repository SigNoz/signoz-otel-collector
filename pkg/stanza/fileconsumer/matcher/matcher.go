...
package matcher // import "github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/matcher"
...
import (
	...
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/matcher/internal/filter"
	"github.com/SigNoz/signoz-otel-collector/pkg/stanza/fileconsumer/matcher/internal/finder"
)
...
var mtimeSortTypeFeatureGate = featuregate.GlobalRegistry().MustRegister(
	"logspipeline.filelog.mtimeSortType",
