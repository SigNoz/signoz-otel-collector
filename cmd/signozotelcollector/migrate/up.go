...
func newSyncUp(dsn string, cluster string, replication bool, timeout time.Duration, logger *zap.Logger) (*up, error) {
...
func (cmd *up) Run(ctx context.Context) error {
...
func (cmd *up) SyncUp(ctx context.Context) error {
...
func (cmd *up) run(ctx context.Context, migrations []schemamigrator.SchemaMigrationRecord, db string) error {
