		...
		UpItems: []Operation{
			...
			CreateTableOperation{
				...
				Engine: Distributed{
					Database:    "signoz_logs",
					Table:       "column_key_evolution_metadata",
					ShardingKey: "cityHash64(base_column, base_key)",
				},
			},
			AddColumnUpdateMetadata{
				Database:       "signoz_logs",
