...
var MetricsMigrations = []SchemaMigrationRecord{
	...
	},
	{
		...
		UpItems: []Operation{
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "samples_v4_reduced_last_5m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
					{Name: "reduced_fingerprint", Type: ColumnTypeUInt64, Codec: "ZSTD(1)"},
					{Name: "unix_milli", Type: ColumnTypeInt64, Codec: "Delta(8), ZSTD(1)"},
					{Name: "last", Type: ColumnTypeFloat64, Codec: "Gorilla, ZSTD(1)"},
					{Name: "min", Type: ColumnTypeFloat64, Codec: "Gorilla, ZSTD(1)"},
					{Name: "max", Type: ColumnTypeFloat64, Codec: "Gorilla, ZSTD(1)"},
					{Name: "sum", Type: ColumnTypeFloat64, Codec: "Gorilla, ZSTD(1)"},
					{Name: "sum_values", Type: ColumnTypeFloat64, Codec: "Gorilla, ZSTD(1)"},
					{Name: "count", Type: ColumnTypeUInt64, Codec: "ZSTD(1)"},
					{Name: "sum_count_series", Type: ColumnTypeUInt64, Codec: "ZSTD(1)"},
					{Name: "count_samples", Type: ColumnTypeUInt64, Codec: "ZSTD(1)"},
					{Name: "computed_at", Type: DateTimeColumnType{}, Default: "now()", Codec: "ZSTD(1)"},
				},
				Engine: ReplacingMergeTree{
					MergeTree: MergeTree{
						...
						Settings: TableSettings{
							{Name: "index_granularity", Value: "8192"},
							{Name: "ttl_only_drop_parts", Value: "1"},
							{Name: "min_age_to_force_merge_seconds", Value: "7200"},
							{Name: "min_age_to_force_merge_on_partition_only", Value: "1"},
						},
					},
					Version: "computed_at",
				},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_samples_v4_reduced_last_5m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "samples_v4_reduced_sum_5m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_samples_v4_reduced_sum_5m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "samples_v4_reduced_last_30m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_samples_v4_reduced_last_30m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "samples_v4_reduced_sum_30m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_samples_v4_reduced_sum_30m",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateRefreshableMaterializedViewOperation{
				Database:     "signoz_metrics",
				ViewName:     "samples_v4_reduced_last_5m_mv",
				DestTable:    "samples_v4_reduced_last_5m",
				RefreshEvery: "5 MINUTE",
				RandomizeFor: "30 SECOND",
				Append:       true,
				Empty:        true,
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}},
					...
					{Name: "reduced_fingerprint", Type: ColumnTypeUInt64},
					{Name: "unix_milli", Type: ColumnTypeInt64},
					{Name: "last", Type: ColumnTypeFloat64},
					{Name: "min", Type: ColumnTypeFloat64},
					{Name: "max", Type: ColumnTypeFloat64},
					{Name: "sum", Type: ColumnTypeFloat64},
					{Name: "sum_values", Type: ColumnTypeFloat64},
					{Name: "count", Type: ColumnTypeUInt64},
					{Name: "sum_count_series", Type: ColumnTypeUInt64},
					{Name: "count_samples", Type: ColumnTypeUInt64},
					{Name: "computed_at", Type: DateTimeColumnType{}},
				},
				Query: `SELECT
						...
						(
							SELECT
								...
								argMax(sum_last, unix_milli) AS last,
								min(min) AS min,
								max(max) AS max,
								sum(sum_last) AS sum,
								sum(sum_values) AS sum_values,
								count() AS count,
								sum(count_series) AS sum_count_series,
								sum(count_samples) AS count_samples
							FROM signoz_metrics.samples_v4_reduced_last_60s FINAL
							WHERE (unix_milli >= (toUnixTimestamp(now() - toIntervalMinute(40)) * 1000))
								AND (unix_milli < (toUnixTimestamp(now() - toIntervalMinute(12)) * 1000))
							GROUP BY
								env,
								temporality,
								metric_name,
			...
			CreateRefreshableMaterializedViewOperation{
				Database:     "signoz_metrics",
				ViewName:     "samples_v4_reduced_sum_5m_mv",
				DestTable:    "samples_v4_reduced_sum_5m",
				RefreshEvery: "5 MINUTE",
				RandomizeFor: "30 SECOND",
				Append:       true,
				Empty:        true,
				...
				// delta sums compose additively across buckets
				Query: `SELECT
							env,
							temporality,
							metric_name,
						...
						(
							SELECT
								...
								sum(count_series) AS sum_count_series,
								sum(count_samples) AS count_samples
							FROM signoz_metrics.samples_v4_reduced_sum_60s FINAL
							WHERE (unix_milli >= (toUnixTimestamp(now() - toIntervalMinute(40)) * 1000))
								AND (unix_milli < (toUnixTimestamp(now() - toIntervalMinute(12)) * 1000))
							GROUP BY
								env,
			...
			CreateRefreshableMaterializedViewOperation{
				Database:     "signoz_metrics",
				ViewName:     "samples_v4_reduced_last_30m_mv",
				DestTable:    "samples_v4_reduced_last_30m",
				RefreshEvery: "30 MINUTE",
				RandomizeFor: "2 MINUTE",
				Append:       true,
				Empty:        true,
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}},
				...
				Query: `SELECT
						...
						(
							SELECT
								...
								metric_name,
								reduced_fingerprint,
								intDiv(unix_milli, 1800000) * 1800000 AS bucket_unix_milli,
								...
								sum(sum_values) AS sum_values,
								sum(count) AS count,
								sum(sum_count_series) AS sum_count_series,
								sum(count_samples) AS count_samples
							FROM signoz_metrics.samples_v4_reduced_last_5m FINAL
							WHERE (unix_milli >= (toUnixTimestamp(now() - toIntervalMinute(180)) * 1000))
								AND (unix_milli < (toUnixTimestamp(now() - toIntervalMinute(40)) * 1000))
							GROUP BY
								env,
								temporality,
								metric_name,
			...
			CreateRefreshableMaterializedViewOperation{
				Database:     "signoz_metrics",
				ViewName:     "samples_v4_reduced_sum_30m_mv",
				DestTable:    "samples_v4_reduced_sum_30m",
				RefreshEvery: "30 MINUTE",
				RandomizeFor: "2 MINUTE",
				Append:       true,
				Empty:        true,
				...
				Query: `SELECT
						...
						(
							SELECT
								...
								sum(sum_count_series) AS sum_count_series,
								sum(count_samples) AS count_samples
							FROM signoz_metrics.samples_v4_reduced_sum_5m FINAL
							WHERE (unix_milli >= (toUnixTimestamp(now() - toIntervalMinute(180)) * 1000))
								AND (unix_milli < (toUnixTimestamp(now() - toIntervalMinute(40)) * 1000))
							GROUP BY
								env,
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "time_series_v4_reduced_6hrs",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_time_series_v4_reduced_6hrs",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "time_series_v4_reduced_1day",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_time_series_v4_reduced_1day",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "time_series_v4_reduced_1week",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateTableOperation{
				Database: "signoz_metrics",
				Table:    "distributed_time_series_v4_reduced_1week",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateMaterializedViewOperation{
				Database:  "signoz_metrics",
				ViewName:  "time_series_v4_reduced_6hrs_mv",
				DestTable: "time_series_v4_reduced_6hrs",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
			...
			CreateMaterializedViewOperation{
				Database:  "signoz_metrics",
				ViewName:  "time_series_v4_reduced_1day_mv",
				DestTable: "time_series_v4_reduced_1day",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
				...
				Query: `SELECT
							...
							__normalized,
							inserted_at_unix_milli
						FROM signoz_metrics.time_series_v4_reduced_6hrs`,
			},
			CreateMaterializedViewOperation{
				Database:  "signoz_metrics",
				ViewName:  "time_series_v4_reduced_1week_mv",
				DestTable: "time_series_v4_reduced_1week",
				Columns: []Column{
					{Name: "env", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'default'"},
					{Name: "temporality", Type: LowCardinalityColumnType{ColumnTypeString}, Default: "'Unspecified'"},
					{Name: "metric_name", Type: LowCardinalityColumnType{ColumnTypeString}},
				...
				Query: `SELECT
							...
							__normalized,
							inserted_at_unix_milli
						FROM signoz_metrics.time_series_v4_reduced_1day`,
			},
		},
		DownItems: []Operation{
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_1week_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_1day_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_6hrs_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_time_series_v4_reduced_1week"},
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_1week"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_time_series_v4_reduced_1day"},
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_1day"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_time_series_v4_reduced_6hrs"},
			DropTableOperation{Database: "signoz_metrics", Table: "time_series_v4_reduced_6hrs"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_sum_30m_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_last_30m_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_sum_5m_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_last_5m_mv"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_samples_v4_reduced_sum_30m"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_sum_30m"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_samples_v4_reduced_last_30m"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_last_30m"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_samples_v4_reduced_sum_5m"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_sum_5m"},
			DropTableOperation{Database: "signoz_metrics", Table: "distributed_samples_v4_reduced_last_5m"},
			DropTableOperation{Database: "signoz_metrics", Table: "samples_v4_reduced_last_5m"},
		},
	},
}
