...
replace (
	github.com/ClickHouse/ch-go v0.67.0 => github.com/SigNoz/ch-go v0.67.0-dd-sketch
	github.com/ClickHouse/clickhouse-go/v2 v2.40.1 => github.com/SigNoz/clickhouse-go/v2 v2.40.1-dd-sketch
